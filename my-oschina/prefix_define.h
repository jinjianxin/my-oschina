...
#ifndef my_oschina_prefix_define_h
#define my_oschina_prefix_define_h

#define new_url @"http://www.oschina.net/action/api/news_list?"
#define blog_url @"http://www.oschina.net/action/api/blog_list?"
#define new_detail @"http://www.oschina.net/action/api/news_detail?"
#define blog_detail @"http://www.oschina.net/action/api/blog_detail?"
#define comments_detail @"http://www.oschina.net/action/api/comment_list?"
#define question_url @"http://www.oschina.net/action/api/post_list?"
#define tweet_url @"http://www.oschina.net/action/api/tweet_list?"
...
#define api_software @"http://www.oschina.net/action/api/software_detail"
